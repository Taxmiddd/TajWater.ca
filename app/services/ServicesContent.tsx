...
const faqs = [
  ...
  { q: 'What areas do you cover?', a: 'We currently deliver to Burnaby, Cloverdale, Coquitlam, Delta, Langley, Langley Township, Maple Ridge, Mary Hill, North Vancouver, Pitt Meadows, Port Coquitlam, Port Moody, Richmond, Squamish, Surrey, Tsawwassen, Vancouver, Walnut Grove, Whistler, and White Rock.' },
  { q: 'How do I pay?', a: 'We accept all major credit and debit cards (Visa, Mastercard, Amex). Pay securely online before delivery, or our driver will bring a Square POS terminal so you can pay by card on delivery. Cash is not accepted. Business accounts can apply for Net-30 invoicing.' },
]
