...
export const metadata: Metadata = {
  title: 'Distilled Water Delivery Coquitlam — CPAP & Medical Use | TajWater $9.99/Jug',
  description: 'Distilled water delivery in Coquitlam & Metro Vancouver. 100% pure distilled water for CPAP machines, medical use, babies, and appliances. 5-gallon jugs, Delivery available, same-day available. From $7.99/jug on subscription.',
  keywords: [
    'distilled water delivery Coquitlam',
    'distilled water delivery Coquitlam & Metro Vancouver',
    'CPAP water delivery Coquitlam',
    'distilled water Coquitlam',
    'pure distilled water delivery BC',
    'distilled water for CPAP Coquitlam & Metro Vancouver',
    'distilled water delivery Burnaby',
    'distilled water delivery Surrey',
    'distilled water delivery Coquitlam',
    '5 gallon distilled water Coquitlam',
    'distilled water for babies Coquitlam',
    'distilled water for humidifier Coquitlam',
    'distilled water subscription Coquitlam',
  ],
  alternates: { canonical: 'https://tajwater.ca/distilled-water-delivery-coquitlam' },
  openGraph: {
    title: 'Distilled Water Delivery Coquitlam — CPAP & Medical | TajWater',
    description: '100% pure distilled water delivered to your door in Coquitlam & Metro Vancouver. Perfect for CPAP machines, babies, and appliances. Delivery available, no contract.',
    url: 'https://tajwater.ca/distilled-water-delivery-coquitlam',
    type: 'website',
  ...
  '@graph': [
    {
      ...
      description: '100% pure distilled water delivered in BPA-free 5-gallon jugs across Coquitlam & Metro Vancouver. Free of all minerals, chlorine, and contaminants. Ideal for CPAP machines, humidifiers, baby formula, medical equipment, and appliances.',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: 'How much does distilled water delivery cost in Coquitlam?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Taj Water distilled water costs $9.99 per 5-gallon jug on a one-time basis. Subscription plans start at $29.99/week or $59.99/month. Delivery is always free across Coquitlam & Metro Vancouver. There is no minimum order, no setup fee, and no contract required.',
          },
        },
        {
          '@type': 'Question',
        ...
        {
          '@type': 'Question',
          name: 'Do you deliver distilled water to North Coquitlam, Burnaby, and Surrey?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Taj Water delivers distilled water to all 21 Coquitlam & Metro Vancouver cities including North Coquitlam, Burnaby, Surrey, Richmond, Coquitlam, Coquitlam, Port Coquitlam, West Coquitlam, Langley, Delta, Port Moody, White Rock, Maple Ridge, Pitt Meadows, Squamish, Whistler, and more. Delivery is always free.',
          },
        },
      ],
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Distilled Water Delivery Coquitlam', item: 'https://tajwater.ca/distilled-water-delivery-coquitlam' },
      ],
    },
  ],
}
...
const cities = [
  ...
  { name: 'North Coquitlam', slug: 'north-coquitlam' },
...
export default function DistilledWaterDeliveryCoquitlam() {
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="hero-gradient py-20 sm:py-28">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-6xl font-extrabold text-white mb-6 leading-tight">
              ...
              <span className="text-[#b3e5fc]">Coquitlam & Metro Vancouver</span>
            </h1>
        ...
        <div className="bg-[#0097a7] py-4">
          <div className="max-w-5xl mx-auto px-4 flex flex-wrap justify-center gap-6 sm:gap-12 text-white text-sm font-semibold">
            ...
            <span>21 Coquitlam & Metro Vancouver Cities</span>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-[#4a7fa5] text-center max-w-2xl mx-auto mb-12 text-lg">
              Distilled water is the right choice whenever purity matters. Here are the most common uses in Coquitlam & Metro Vancouver households.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The #1 reason Coquitlam & Metro Vancouver residents order distilled water. Required by all major CPAP brands for humidifier chambers. Prevents mineral scale buildup and bacterial growth.',
                },
                {
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl border-2 border-[#0097a7] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0c2340] mb-4 text-center">
                CPAP Water Delivery in Coquitlam & Metro Vancouver
              </h2>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0c2340] mb-4">
              Distilled Water Delivery Pricing — Coquitlam & Metro Vancouver
            </h2>
        ...
        <section className="py-20 bg-[#f0f9ff]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center text-sm">
              <Link href="/spring-water-delivery-coquitlam" className="bg-white border border-[#cce7f0] rounded-xl p-4 hover:border-[#0097a7] transition-colors text-[#0097a7] font-semibold">
                Spring Water Delivery Coquitlam →
              </Link>
              <Link href="/alkaline-water-delivery-coquitlam" className="bg-white border border-[#cce7f0] rounded-xl p-4 hover:border-[#0097a7] transition-colors text-[#0097a7] font-semibold">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0c2340] mb-4">
              Distilled Water Delivery — All Coquitlam & Metro Vancouver Cities
            </h2>
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  q: 'How much does distilled water delivery cost in Coquitlam?',
                  a: 'Taj Water distilled water costs $9.99 per 5-gallon jug on a one-time basis. Subscription plans start at $29.99/week or $59.99/month. Delivery is always free across Coquitlam & Metro Vancouver. There is no minimum order, no setup fee, and no contract required.',
                },
                {
                ...
                {
                  q: 'Do you deliver distilled water to North Coquitlam, Burnaby, and Surrey?',
                  a: 'Yes. Taj Water delivers distilled water to all 21 Coquitlam & Metro Vancouver cities including North Coquitlam, Burnaby, Surrey, Richmond, Coquitlam, Coquitlam, Port Coquitlam, West Coquitlam, Langley, Delta, Port Moody, White Rock, Maple Ridge, Pitt Meadows, Squamish, Whistler, and more. Delivery is always free.',
                },
              ].map((item) => (
        ...
        <section className="py-20 bg-gradient-to-r from-[#0097a7] to-[#006064]">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-[#b3e5fc] text-lg mb-8">
              ...
              delivered free to your door anywhere in Coquitlam & Metro Vancouver.
            </p>
