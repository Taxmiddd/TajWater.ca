...
import { Building, Mail, Phone, MapPin, CheckCircle2, XCircle, Search } from 'lucide-react'
import { Input } from '@/components/ui/input'
import { Button } from '@/components/ui/button'
import { Badge } from '@/components/ui/badge'

// Mock data for wholesale applications
const mockApplications = [
  { id: 1, name: 'Fitness Plus Gym', contact: 'Sarah Jenkins', email: 'sarah@fitnessplus.ca', phone: '604-555-0123', city: 'Vancouver', status: 'pending', date: 'Oct 24, 2026' },
  { id: 2, name: 'Main St Grocery', contact: 'David Lee', email: 'david@mainstgrocery.com', phone: '778-555-9876', city: 'Coquitlam', status: 'approved', date: 'Oct 22, 2026' },
  { id: 3, name: 'TechHub Offices', contact: 'Amanda Chen', email: 'admin@techhub.io', phone: '604-555-4567', city: 'Burnaby', status: 'pending', date: 'Oct 20, 2026' },
]
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="font-bold text-[#0c2340] dark:text-white text-lg">{app.name}</h3>
                  <Badge className={
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-[#4a7fa5] dark:text-[#b3e5fc]/70">
                  ...
                  <span className="flex items-center gap-1"><MapPin className="w-3.5 h-3.5" /> {app.city}</span>
                </div>
                <p className="text-xs text-[#4a7fa5]/70 dark:text-[#b3e5fc]/50 mt-2">Applied: {app.date} · Contact: {app.contact}</p>
              </div>
            </div>
