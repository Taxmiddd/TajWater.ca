...
export const metadata: Metadata = {
  title: 'Water Delivery Surrey — Spring, Alkaline & Distilled | Taj Water',
  description: 'Premium 5-gallon water jug delivery in Surrey, BC. Spring, alkaline, and distilled water delivered directly to your home or office. Same-day delivery available.',
  keywords: [
    'water delivery Surrey',
    'water delivery Surrey BC',
    '5 gallon water jug delivery Surrey',
    'alkaline water Surrey',
    'spring water Surrey',
    'distilled water Surrey',
    'water cooler delivery Surrey',
  ],
  alternates: { canonical: 'https://tajwater.ca/water-delivery-surrey' },
}

export default function WaterDeliverySurrey() {
  return (
    <main className="min-h-screen">
      <section className="hero-gradient py-20 sm:py-28 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
            <MapPin className="w-4 h-4" /> Serving All of Surrey
          </div>
          <h1 className="text-4xl sm:text-6xl font-extrabold text-white mb-6 leading-tight">
            Premium Water Delivery in <span className="text-[#b3e5fc]">Surrey</span>
          </h1>
          <p className="text-[#b3e5fc] text-lg sm:text-xl mb-10 max-w-2xl mx-auto">
            Get 5-gallon jugs of spring, alkaline, or distilled water delivered straight to your door in Surrey. Fast, reliable, and hassle-free.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-extrabold text-[#0c2340] mb-12">Why Choose TajWater in Surrey?</h2>
          <div className="grid sm:grid-cols-3 gap-8">
            <div className="bg-[#f0f9ff] p-6 rounded-2xl border border-[#cce7f0]">
              ...
              <p className="text-[#4a7fa5] text-sm">We cover all Surrey neighborhoods with same-day and scheduled delivery options.</p>
            </div>
            <div className="bg-[#f0f9ff] p-6 rounded-2xl border border-[#cce7f0]">
