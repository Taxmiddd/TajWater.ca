...
const posts = [
  ...
  {
    slug: 'water-delivery-vs-home-water-filter-metro-vancouver',
    title: 'Water Delivery vs Home Water Filter in Metro Vancouver (2026 Guide)',
    description: 'Comparing 5-gallon water delivery vs under-sink or countertop water filters for Metro Vancouver homes. Real cost analysis, pros, cons, and which is right for your household.',
    date: '2026-05-13',
    readTime: '7 min read',
