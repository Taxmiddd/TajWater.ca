...
export const metadata: Metadata = {
  title: 'Alkaline Water Delivery Coquitlam — 5-Gallon Jugs $10.99 | Taj Water',
  description: 'Alkaline water delivery in Coquitlam & Metro Vancouver. pH balanced alkaline water delivered to your door in 5-gallon jugs. Same-day available, Delivery available, no contract. $10.99/jug.',
  keywords: [
    'alkaline water delivery Coquitlam',
    'alkaline water delivery Coquitlam & Metro Vancouver',
    'alkaline water delivery Burnaby',
    'alkaline water delivery Surrey',
    'alkaline water delivery Coquitlam',
    '5 gallon alkaline water Coquitlam',
    'alkaline water jug delivery BC',
    'alkaline water subscription Coquitlam',
    'best alkaline water Coquitlam',
  ],
  alternates: { canonical: 'https://tajwater.ca/alkaline-water-delivery-coquitlam' },
  openGraph: {
    title: 'Alkaline Water Delivery Coquitlam — $10.99/Jug | Taj Water',
    description: 'pH balanced alkaline water delivered to your door in Coquitlam & Metro Vancouver. Same-day available, Delivery available, no contract.',
    url: 'https://tajwater.ca/alkaline-water-delivery-coquitlam',
    type: 'website',
  ...
  '@graph': [
    {
      ...
      description: 'pH balanced alkaline water delivered in BPA-free 5-gallon jugs across Coquitlam & Metro Vancouver. Rich in electrolytes and perfect for an active lifestyle.',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: 'How much does alkaline water delivery cost in Coquitlam?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Taj Water alkaline water is $10.99 per 5-gallon jug with Delivery available across Coquitlam & Metro Vancouver. Subscription plans start at $29.99/week. No minimum order, no setup fees, no contracts.',
          },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Taj Water delivers alkaline water to all 21 Coquitlam & Metro Vancouver cities including Burnaby, Surrey, Richmond, Coquitlam, Port Coquitlam, North Coquitlam, West Coquitlam, Langley, Delta, Port Moody, White Rock, Maple Ridge, Pitt Meadows, Squamish, Whistler, and more. Delivery is free on every order.',
          },
        },
        {
          '@type': 'Question',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Alkaline Water Delivery Coquitlam', item: 'https://tajwater.ca/alkaline-water-delivery-coquitlam' },
      ],
    },
  ],
}
...
export default function AlkalineWaterDeliveryCoquitlam() {
  return (
    <>
        ...
        <section className="hero-gradient py-20 sm:py-28">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-[#b3e5fc] text-lg sm:text-xl max-w-3xl mx-auto mb-10">
              ...
              Delivery available across all 21 Coquitlam & Metro Vancouver cities. Same-day available before 12pm.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#4a7fa5] leading-relaxed mb-4">
                  ...
                  It is the top choice among Taj Water&apos;s active and health-conscious customers across Coquitlam & Metro Vancouver.
                </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0c2340] text-center mb-4">
              Why Coquitlam & Metro Vancouver Residents Choose Alkaline Water
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Sports-active households in Coquitlam, North Coquitlam, and Burnaby choose alkaline water for everyday hydration.',
                },
                {
        ...
        <section className="py-20 bg-[#f0f9ff]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0c2340] mb-4">
              Alkaline Water Delivery Pricing — Coquitlam & Metro Vancouver
            </h2>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center text-sm">
              <Link href="/spring-water-delivery-coquitlam" className="bg-[#f0f9ff] border border-[#cce7f0] rounded-xl p-4 hover:border-[#0097a7] transition-colors text-[#0097a7] font-semibold">
              ...
              <Link href="/distilled-water-delivery-coquitlam" className="bg-[#f0f9ff] border border-[#cce7f0] rounded-xl p-4 hover:border-[#0097a7] transition-colors text-[#0097a7] font-semibold">
        ...
        <section className="py-20 bg-[#f0f9ff]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0c2340] mb-4">
              Alkaline Water Delivery — All Coquitlam & Metro Vancouver Cities
            </h2>
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  q: 'How much does alkaline water delivery cost in Coquitlam?',
                  a: 'Taj Water alkaline water is $10.99 per 5-gallon jug with Delivery available across Coquitlam & Metro Vancouver. Subscription plans start at $29.99/week. No minimum order, no setup fees, no contracts.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'Yes. Taj Water delivers alkaline water to all 21 Coquitlam & Metro Vancouver cities including Burnaby, Surrey, Richmond, Coquitlam, Port Coquitlam, North Coquitlam, West Coquitlam, Langley, Delta, Port Moody, White Rock, Maple Ridge, Pitt Meadows, Squamish, Whistler, and more. Delivery is free on every order.',
                },
                {
        ...
        <section className="py-20 bg-gradient-to-r from-[#0097a7] to-[#006064]">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-[#b3e5fc] text-lg mb-8">
              pH balanced alkaline water delivered to your door anywhere in Coquitlam & Metro Vancouver.
