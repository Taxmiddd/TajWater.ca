...
export const metadata: Metadata = {
  title: 'Water Delivery Burnaby — Spring, Alkaline & Distilled | Taj Water',
  description: 'Premium 5-gallon water jug delivery in Burnaby, BC. Spring, alkaline, and distilled water delivered directly to your home or office. Same-day delivery available.',
  keywords: [
    'water delivery Burnaby',
    'water delivery Burnaby BC',
    '5 gallon water jug delivery Burnaby',
    'alkaline water Burnaby',
    'spring water Burnaby',
    'distilled water Burnaby',
    'water cooler delivery Burnaby',
  ],
  alternates: { canonical: 'https://tajwater.ca/water-delivery-burnaby' },
}

export default function WaterDeliveryBurnaby() {
  return (
    <main className="min-h-screen">
      <section className="hero-gradient py-20 sm:py-28 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
            <MapPin className="w-4 h-4" /> Serving All of Burnaby
          </div>
          <h1 className="text-4xl sm:text-6xl font-extrabold text-white mb-6 leading-tight">
            Premium Water Delivery in <span className="text-[#b3e5fc]">Burnaby</span>
          </h1>
          <p className="text-[#b3e5fc] text-lg sm:text-xl mb-10 max-w-2xl mx-auto">
            Get 5-gallon jugs of spring, alkaline, or distilled water delivered straight to your door in Burnaby. Fast, reliable, and hassle-free.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-extrabold text-[#0c2340] mb-12">Why Choose TajWater in Burnaby?</h2>
          <div className="grid sm:grid-cols-3 gap-8">
            <div className="bg-[#f0f9ff] p-6 rounded-2xl border border-[#cce7f0]">
              ...
              <p className="text-[#4a7fa5] text-sm">We cover all Burnaby neighborhoods with same-day and scheduled delivery options.</p>
            </div>
            <div className="bg-[#f0f9ff] p-6 rounded-2xl border border-[#cce7f0]">
      ...
      <section className="py-20 bg-[#f0f9ff]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/shop" className="bg-[#0097a7] text-white hover:bg-[#006064] font-bold px-8 py-4 rounded-xl text-lg inline-block">
            Order Now for Burnaby Delivery
          </Link>
        </div>
      </section>
    </main>
