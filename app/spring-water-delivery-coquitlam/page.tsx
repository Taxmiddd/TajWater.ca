...
export const metadata: Metadata = {
  title: 'Spring Water Delivery Coquitlam — 5-Gallon Jugs from $8.99 | TajWater',
  description: 'Natural spring water delivered in 5-gallon BPA-free jugs across Coquitlam & Metro Vancouver. $8.99/jug, delivery available, same-day available. No contracts. From TajWater, Port Coquitlam.',
  keywords: [
    'spring water delivery Coquitlam',
    'natural spring water delivery Coquitlam & Metro Vancouver',
    '5 gallon spring water Coquitlam',
    'spring water jug delivery BC',
    'spring water delivery Burnaby',
    'spring water delivery Surrey',
    'spring water delivery Coquitlam',
    'best spring water delivery Coquitlam',
  ],
  alternates: { canonical: 'https://tajwater.ca/spring-water-delivery-coquitlam' },
  openGraph: {
    title: 'Spring Water Delivery Coquitlam — $8.99/Jug | TajWater',
    description: 'Natural spring water in 5-gallon BPA-free jugs. Fast delivery across all 21 Coquitlam & Metro Vancouver zones. Same-day available before 12pm.',
    url: 'https://tajwater.ca/spring-water-delivery-coquitlam',
    type: 'website',
...
const productSchema = {
  ...
  description: 'Fresh natural spring water sourced from BC mountain aquifers, delivered in 5-gallon (20L) BPA-free polycarbonate jugs to homes and offices across Coquitlam & Metro Vancouver. Naturally occurring calcium, magnesium, and potassium.',
  ...
  offers: {
    ...
    areaServed: 'Coquitlam & Metro Vancouver, BC, Canada',
    shippingDetails: {
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Is Taj Water spring water pH balanced?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Taj Water spring water is naturally pH balanced, which is ideal for daily drinking. It retains its natural mineral profile, making it the most popular choice for families and offices across Coquitlam & Metro Vancouver.' } },
    { '@type': 'Question', name: 'How much does spring water delivery cost in Coquitlam?', acceptedAnswer: { '@type': 'Answer', text: 'Taj Water spring water is $8.99 per 5-gallon (20L) jug with delivery available across all Coquitlam & Metro Vancouver zones. Subscription plans start at $29.99/week or $59.99/month. There are no zone surcharges, no minimum orders, and no contracts.' } },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Spring Water Delivery Coquitlam', item: 'https://tajwater.ca/spring-water-delivery-coquitlam' },
  ],
}

const cities = ['Coquitlam', 'Burnaby', 'Richmond', 'Surrey', 'Coquitlam', 'Port Coquitlam', 'North Coquitlam', 'West Coquitlam', 'Langley', 'Delta', 'Port Moody', 'White Rock', 'Maple Ridge', 'Squamish']
      ...
      <main className="min-h-screen">
        ...
        <section className="py-24 hero-gradient">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-5 leading-tight">
              Natural Spring Water Delivery<br />Across Coquitlam & Metro Vancouver
            </h1>
        ...
        <section className="py-20 bg-[#f0f9ff]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-[#4a7fa5] text-center max-w-2xl mx-auto mb-12">
              Spring water is the most popular water type we deliver across Coquitlam & Metro Vancouver — and for good reason.
            </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-[#4a7fa5] text-center mb-10">All three are available for delivery across Coquitlam & Metro Vancouver. Not sure which is right for you? <Link href="/blog/spring-vs-alkaline-vs-distilled-water-coquitlam" className="text-[#0097a7] font-semibold hover:underline">Read our full guide →</Link></p>
        ...
        <section className="py-20 bg-[#f0f9ff]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-extrabold text-[#0c2340] text-center mb-4">Spring Water Delivery Across Coquitlam & Metro Vancouver</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-[#0097a7] to-[#006064]">
          <div className="max-w-3xl mx-auto px-4 text-center text-white">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <Link href="/alkaline-water-delivery-coquitlam" className="px-8 py-3 bg-white/20 text-white font-semibold rounded-xl border-2 border-white/40 hover:bg-white/30 transition-colors">Compare Alkaline Water</Link>
            </div>
          </div>
        </section>
      </main>
